...
describe('ApprovalState enum', () => {
  it('should have all expected states', () => {
    ...
    expect(ApprovalState.ACCOUNT_AVAILABILITY_CHECK).toBe('ACCOUNT_AVAILABILITY_CHECK');
...
describe('TERMINAL_STATES', () => {
  ...
  it('should not include non-terminal states', () => {
    ...
    expect(TERMINAL_STATES).not.toContain(ApprovalState.ACCOUNT_AVAILABILITY_CHECK);
...
describe('isTerminalState', () => {
  ...
  it('should return false for non-terminal states', () => {
    ...
    expect(isTerminalState(ApprovalState.ACCOUNT_AVAILABILITY_CHECK)).toBe(false);
