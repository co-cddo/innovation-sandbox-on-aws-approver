 ...
 */
export interface SlackDenyLambdaProps {
  /** ISB Leases Lambda function name for denial invocation */
  isbLeasesLambdaName: string;
  /** Approver email for automated denials */
 ...
 */
export class SlackDenyLambda extends Construct {
  /** The Lambda function */
  ...
  constructor(scope: Construct, id: string, props: SlackDenyLambdaProps) {
    ...
    this.function = new nodejs.NodejsFunction(this, 'Function', {
      ...
      entry: 'src/handlers/slack-deny.ts',
      handler: 'handler',
    ...
    cdk.Tags.of(this.function).add('Story', '7.2.2');
